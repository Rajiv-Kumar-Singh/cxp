...
// import thumbnails
import threeDSphere from '~/assets/thumbnails/html-text-sphere.jpg';

// import code file
import codes from '~/assets/codes/htmlSphere.js';
  ...
  data() {
    return {
      content: {
        ...
        video: '',
        description:
          '👋 Hi there, In this post you will learn to create this awesome 3D rotating text sphere using HTML, CSS, JavaScript and a package named TagCloud.js.',
        info: [
          {
        ...
        youtubeVideo: 'https://www.youtube.com/embed/Y4Jl1Ql9qFI',
      },
      codeContent: {
        htmlSyntax: true,
